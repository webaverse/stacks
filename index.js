...
const {useThreeUtils, useLoaders, usePhysics, useCleanup} = metaversefile;
...
export default e => {
  ...
  // load
  let fortniteMesh = null;
  let modularMesh = null;
  let sakuraMesh = null;
  let diffuse1 = null;
  let normal1 = null;
  e.waitUntil((async () => {
    ...
    await Promise.all([
      (async () => {
        fortniteMesh = await new Promise((accept, reject) => {
      ...
      (async () => {
        modularMesh = await new Promise((accept, reject) => {
      ...
      (async () => {
        sakuraMesh = await new Promise((accept, reject) => {
      ...
      (async () => {
        await new Promise((accept, reject) => {
          diffuse1 = textureLoader.load(`https://webaverse.github.io/street-assets/textures/${prefix}_Base_Color.jpg`, accept);
      ...
      (async () => {
        await new Promise((accept, reject) => {
          normal1 = textureLoader.load(`https://webaverse.github.io/street-assets/textures/${prefix}_Normal.jpg`, accept);
